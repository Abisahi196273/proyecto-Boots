...
query = 'SELECT distinct [MANI_BUQUE] from TBL_BUQUES_MARINE_TRAFFIC mb left join dbo.TBL_BUQUES b on b.NOMBRE = mb.MANI_BUQUE where b.NOMBRE is null ORDER BY MANI_BUQUE;'
